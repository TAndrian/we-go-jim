...
import static com.project.we_go_jim.controller.ResourcesPath.PATH_BOOKING_ID;
import static com.project.we_go_jim.controller.ResourcesPath.PATH_USER_ID;
...
public class BookingResourceController {
    ...
    @PostMapping(API_BOOKING + "/" + USER + PATH_USER_ID)
    @ResponseStatus(HttpStatus.CREATED)
    public BookingDTO createOneForUser(@PathVariable UUID userId, @RequestBody CreateBookingDTO bookingToCreate) {
        return bookingService.createOneForUser(userId, bookingToCreate);
    }

    @PostMapping(API_BOOKING + PATH_BOOKING_ID + "/" + USER + PATH_USER_ID)
    @ResponseStatus(HttpStatus.OK)
    public BookingDTO addBookingToUser(@PathVariable UUID bookingId, @PathVariable UUID userId) {
