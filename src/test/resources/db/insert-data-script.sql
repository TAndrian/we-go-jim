...
INSERT INTO booking (id, start_time, end_time, max_participant) VALUES
  ('f255538a-8a02-4c43-adf4-aa37cce43894', '2024-06-21T10:00:00', '2024-06-21T12:00:00', 10),
...
INSERT INTO users_bookings (user_id, booking_id) VALUES
  ((SELECT id FROM users WHERE email = 'john.doe@example.com'), (SELECT id FROM booking WHERE start_time = '2024-06-21T10:00:00')),
